...
\namesection{Samuel}{Fleischer}{
    \href{mailto:samfleischer@ucdavis.edu}{SamFleischer@UCDavis.edu} $\ \ |\ \ $ 661~$\cdot$~714~$\cdot$~2487 $\ \ |\ \ $ \href{https://www.linkedin.com/in/samfleischer/}{LinkedIn.com/in/SamFleischer} $\ \ |\ \ $ he~$\cdot$~him~$\cdot$~his
}
...
\runsubsection{GRADUATE STUDENT INTERN}
\descript{| NASA, JPL}
\location{June 2018 - Present | Planning and Execution Systems (397J)}
\vspace{\topsep}
\begin{tightitemize}
